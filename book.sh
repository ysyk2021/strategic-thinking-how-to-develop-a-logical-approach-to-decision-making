...
ebook-convert strategic-thinking-how-to-develop-a-logical-approach-to-decision-making.epub strategic-thinking-how-to-develop-a-logical-approach-to-decision-making.docx --no-chapters-in-toc --chapter-mark=none --disable-markup-chapter-headings --docx-no-toc --docx-no-cover --docx-page-size=a5 --extra-css page_styles.css
